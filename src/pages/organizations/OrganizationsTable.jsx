...
export default function DataTable() {
  ...
  useEffect(() => {
    axios
      .get(`https://plazer-backend-production.up.railway.app/orgAdmin/findAllOrganization`)
      .then((res) => {
        setRows(res.data);
  ...
  const handleFilter = useCallback(
    (event) => {
      ...
      const newData = rows.filter((row) => {
        return row.orgName.toLowerCase().includes(query);
      });
  ...
  const handleDisable = (orgId, currentActiveStatus) => {
    ...
    axios
      .patch(`https://plazer-backend-production.up.railway.app/orgAdmin/${orgId}/active`, {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Button
          ...
          to={`/organization/${params.row.orgId}/organization-details`} // Navigate to the organization's API endpoint
          color="primary"
